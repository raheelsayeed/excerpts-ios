...
//        style.progressBarHeight = 1.0+1.0/[[UIScreen mainScreen] scale];
        style.barColor = [UIColor clearColor];// [kColor_MainViewBG colorWithAlphaComponent:0.8];
        style.textColor = [UIColor clearColor]; //kColor_SVT;
        style.progressBarHeight = 3.f+1.0/[[UIScreen mainScreen] scale];
        style.progressBarColor = [UIColor colorWithRed:0.20 green:0.66 blue:0.86 alpha:0.9];
