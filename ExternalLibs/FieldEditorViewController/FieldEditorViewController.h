...
- (void)fieldEditor:(FieldEditorViewController *)editor segmentChangedWithKey:(NSString *)key withValue:(id)value;
...
@interface NamedSegmentedController : UISegmentedControl{
    NSString *name;
}
@property (nonatomic, retain) NSString *name;
